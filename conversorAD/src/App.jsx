      ...
      <section className='row'>
        ...
        <article className='col-lg-5 card card-body'>
          ...
          <form action="/enviar" method="post">
            ...
            <button type='submit' className='btn btn-primary mt-3'>EXPORTAR</button>
          </form>
        ...
        <article className='card card-body col-lg-3'>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia veritatis dolorum possimus, quaerat nisi ipsum nihil voluptas accusantium esse debitis ea fugit hic eveniet quos at! Eius recusandae aliquam minus!</p>
        </article>
